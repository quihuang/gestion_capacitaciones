...
<body>
    <div class="container">
        <h2>Registrar Verificación de Eficacia</h2>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="date" id="fecha_verificacion" name="fecha_verificacion" required>
            </div>
            <div class="form-group">
                <label for="responsable_verificacion">Responsable de Verificación:</label>
                <input type="text" id="responsable_verificacion" name="responsable_verificacion" required>
            </div>
            ...
            <button type="submit" class="button">Registrar Verificación</button>
        </form>
    </div>
