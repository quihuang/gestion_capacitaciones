    ...
    <div class="container">
        ...
        <form id="formAsistente">
            ...
            <div class="form-group">
                ...
                <select id="tema_id" name="tema_id" class="form-control" required>
                    ...
                    <?php while ($row = $temas->fetch(PDO::FETCH_ASSOC)) : ?>
                        <option value="<?php echo $row['id']; ?>" <?php echo $asistente['tema_id'] == $row['id'] ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" value="<?php echo htmlspecialchars($asistente['nombre']); ?>" required>
            </div>
            <div class="form-group">
                <label for="cargo">Cargo:</label>
                <input type="text" id="cargo" name="cargo" value="<?php echo htmlspecialchars($asistente['cargo']); ?>" required>
            </div>
            <div class="form-group">
                <label for="firma">Firma:</label>
                <input type="text" id="firma" name="firma" value="<?php echo htmlspecialchars($asistente['firma']); ?>" required>
            </div>
            <button onclick="window.location.href='index.php?controller=asistente&action=index'" class="button" style="margin-bottom: 10px;" title="Regresar"> Regresar 
            ...
            <button type="submit" class="button">Actualizar Asistente</button>
        </form>
    </div>
